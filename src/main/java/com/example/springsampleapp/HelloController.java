...
public class HelloController {
	...
	public String hello() {
		...
		sb.append("<center><p><h1><font color="#0000FF">Hello, Prasanna!!</font> <font color="#FF0000">Ciao Gabry!!<font></center>  </h1><br> I wonder if you ever visited any of the following cities: <br><ul>");
