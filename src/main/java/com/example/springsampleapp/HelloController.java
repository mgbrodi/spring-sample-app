...
public class HelloController {
	...
	public String hello() {
		...
		sb.append("<center><h1><p style="color:blue">Hello, Prasanna!!</p><p style="color:red"> Ciao Gabry!!</p></center>  </h1><br> I wonder if you ever visited any of the following cities: <br><ul>");
